    ...
    <>
      <div className="py-10 bg-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center mb-8">Join NSS Organization</h2>
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <div className="flex flex-col md:flex-row items-center">
              ...
              />
              <div>
                <h3 className="text-2xl font-semibold mb-4">About NSS Organization</h3>
                ...
                >
                  Register for NSS Organization Membership
                </a>
              </div>
            </div>
          </div>
